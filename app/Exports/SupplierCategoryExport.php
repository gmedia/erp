...
class SupplierCategoryExport implements FromQuery, ShouldAutoSize, WithHeadings, WithMapping, WithStyles
{
    /**
    ...
    /**
     * Map each SupplierCategory model to a row.
     *
     * @param  SupplierCategory  $supplierCategory
     * @return array<int, mixed>
     */
    public function map($supplierCategory): array
    {
        return [
            $supplierCategory->id,
