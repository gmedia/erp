...
class CustomerCategoryExport implements FromQuery, ShouldAutoSize, WithHeadings, WithMapping, WithStyles
{
    /**
    ...
    /**
     * Map each CustomerCategory model to a row.
     *
     * @param  CustomerCategory  $customerCategory
     * @return array<int, mixed>
     */
    public function map($customerCategory): array
    {
        return [
            $customerCategory->id,
