...
class IndexBankReconciliationsAction
{
    ...
    public function execute(IndexBankReconciliationRequest $request): LengthAwarePaginator
    {
        ...
        return $this->handleIndexRequest($request, $query, $this->filterService, ['notes'], ['status', 'account_id', 'fiscal_year_id', 'date_from', 'date_to'], 'reconciliation_date', ['reconciliation_date', 'period_start', 'period_end', 'statement_balance', 'book_balance', 'difference', 'status', 'created_at']);
    }
}
