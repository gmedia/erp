...
class IndexPurchaseRequestRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'status' => ['nullable', 'string', 'in:draft,pending_approval,approved,rejected,partially_ordered,fully_ordered,cancelled'],
            ...
            'sort_by' => ['nullable', 'string', 'in:id,pr_number,branch,branch_id,department,department_id,requester,requested_by,request_date,required_date,priority,status,estimated_amount,created_at,updated_at'],
