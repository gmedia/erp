...
class ExportAssetStocktakeVarianceRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'sort_by' => ['nullable', 'string', 'in:id,stocktake_reference,asset_code,asset_name,expected_branch,expected_location,found_branch,found_location,result,checked_at'],
