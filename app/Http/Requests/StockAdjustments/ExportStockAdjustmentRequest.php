...
class ExportStockAdjustmentRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'sort_by' => ['nullable', 'string', 'in:id,adjustment_number,warehouse_id,adjustment_date,adjustment_type,status,inventory_stocktake_id,created_at,updated_at'],
