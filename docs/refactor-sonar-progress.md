...
- Batch E regression fixes: ✅ done (2026-06-25). 2 waves + 2 bug fixes. All verifications green. Not yet committed — 11 modified files + 1 untracked in working tree.
- **Next action**: Commit and push Batch E regression fixes.
