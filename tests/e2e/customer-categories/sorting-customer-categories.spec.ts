...
test.describe('Customer Category Management - Sorting', () => {
  test('should sort customer categories by name', async ({ page }) => {
    await login(page);
  ...
  test('should sort customer categories by Created At', async ({ page }) => {
    await login(page);
    await page.goto('/customer-categories');
  ...
  test('should sort customer categories by Updated At', async ({ page }) => {
    await login(page);
    await page.goto('/customer-categories');
