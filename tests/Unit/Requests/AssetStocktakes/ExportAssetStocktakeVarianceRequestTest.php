...
test('authorize returns true for asset stocktake variance export request', function () {
    $request = new ExportAssetStocktakeVarianceRequest;

    expect($request->authorize())->toBeTrue();
});

test('rules returns correct validation rules for asset stocktake variance export request', function () {
    $request = new ExportAssetStocktakeVarianceRequest;
