...
const CustomerCategories = lazy(
    () => import('./pages/customer-categories/index'),
);
const Suppliers = lazy(() => import('./pages/suppliers/index'));
const SupplierCategories = lazy(
    () => import('./pages/supplier-categories/index'),
);

// Products & Inventory
const Products = lazy(() => import('./pages/products/index'));
const ProductCategories = lazy(
    () => import('./pages/product-categories/index'),
);
...
const InventoryStocktakes = lazy(
    () => import('./pages/inventory-stocktakes/index'),
);
...
const AssetMaintenances = lazy(
    () => import('./pages/asset-maintenances/index'),
);
...
const AssetStocktakePerform = lazy(
    () => import('./pages/asset-stocktakes/perform'),
);
const AssetDepreciationRuns = lazy(
...
const PipelineAuditTrail = lazy(
    () => import('./pages/pipeline-audit-trail/index'),
);
const ApprovalFlows = lazy(() => import('./pages/approval-flows/index'));
const ApprovalDelegations = lazy(
    () => import('./pages/approval-delegations/index'),
);
const ApprovalMonitoring = lazy(
    () => import('./pages/approval-monitoring/index'),
);
const ApprovalAuditTrail = lazy(
    () => import('./pages/approval-audit-trail/index'),
);
...
const ReportBookValueDepreciation = lazy(
    () => import('./pages/reports/book-value-depreciation/index'),
);
...
const ReportInventoryValuation = lazy(
    () => import('./pages/reports/inventory-valuation/index'),
);
const ReportInventoryStocktakeVariance = lazy(
    () => import('./pages/reports/inventory-stocktake-variance/index'),
);
const ReportStockMovement = lazy(
    () => import('./pages/reports/stock-movement/index'),
);
    ...
    return (
        <Suspense fallback={<PageLoader />}>
            <Routes>
                ...
                />
                <Route
                    path="/asset-stocktakes/:id/perform"
                    element={
                        <P>
                            <AssetStocktakePerform />
                        </P>
                    }
                />
                <Route
                    path="/asset-depreciation-runs"
                    element={
                        <P>
                ...
                />
                <Route
                    path="/reports/book-value-depreciation"
                    element={
                        <P>
                            <ReportBookValueDepreciation />
                        </P>
                    }
                />
                <Route
                ...
                />
                <Route
                    path="/reports/asset-stocktake-variances"
                    element={
                        <P>
                            <ReportAssetStocktakeVariances />
                        </P>
                    }
                />
                <Route
                ...
                />
                <Route
                    path="/reports/inventory-stocktake-variance"
                    element={
                        <P>
