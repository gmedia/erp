    ...
    const defaultValues: PipelineTransitionFormData = useMemo(() => {
        ...
        return {
            ...
            guard_conditions: transition.guard_conditions
                ? JSON.stringify(transition.guard_conditions, null, 2)
                : '',
    ...
    const onSubmit = async (
        ...
        const payload = {
            ...
            guard_conditions: data.guard_conditions
                ? JSON.parse(data.guard_conditions)
                : null,
            actions:
                data.actions?.map((a) => ({
                    ...a,
        ...
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="max-h-[90vh] max-w-3xl overflow-y-auto">
                <DialogHeader>
                    ...
                    <DialogDescription>
                        Configure state transition rules, conditions, and
                        actions for this pipeline.
                    </DialogDescription>
                </DialogHeader>
                        ...
                        <Tabs defaultValue="details">
                            ...
                            <TabsContent value="details" className="space-y-4">
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    <InputField
                                        name="name"
                                        label="Name (e.g. Approve)"
                                    />
                                    <InputField
                                        name="code"
                                        label="Code (e.g. approve_order)"
                                    />
                                </div>
                            ...
                            <TabsContent value="actions" className="space-y-4">
                                <div className="flex items-center justify-between rounded bg-muted p-2">
                                    <p className="text-sm text-muted-foreground">
                                        Actions execute side effects when this
                                        transition occurs.
                                    </p>
                                    <Button
                                        type="button"
