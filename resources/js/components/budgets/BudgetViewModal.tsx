...
export const BudgetViewModal = memo<BudgetViewModalProps>(function BudgetViewModal({
    item,
    open,
    onClose,
}) {
                ...
                <div className="space-y-6 py-2">
                    <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                        ...
                        <div className="min-w-0">
                            ...
                            <Badge variant={getBudgetStatusVariant(item.status)}>
                        ...
                        {item.approver && (
                            <>
                                ...
                                <div className="min-w-0">
                                    ...
                                    <p>
                                        {item.approved_at
                                            ? formatDateByRegionalSettings(item.approved_at)
                                            : '-'}
                                    </p>
                                </div>
                            </>
                                ...
                                <TableBody>
                                    {(item.lines ?? []).map((line, idx) => (
                                        <TableRow key={line.id ?? idx}>
                                            ...
                                            <TableCell>
                                                {formatDateByRegionalSettings(line.period_start)}
                                            </TableCell>
                                            <TableCell>
                                                {formatDateByRegionalSettings(line.period_end)}
                                            </TableCell>
