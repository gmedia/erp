...
const getAssetFormDefaults = (asset?: Asset | null): AssetFormData => {
    ...
    return {
        ...
        name: asset.name,
        asset_category_id: asset.category?.id ? String(asset.category.id) : String(asset.asset_category_id),
        asset_model_id: asset.model?.id ? String(asset.model.id) : (asset.asset_model_id ? String(asset.asset_model_id) : ''),
        serial_number: asset.serial_number || '',
        barcode: asset.barcode || '',
        branch_id: asset.branch?.id ? String(asset.branch.id) : String(asset.branch_id),
