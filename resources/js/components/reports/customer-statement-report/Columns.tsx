...
export const customerStatementReportColumns: ColumnDef<CustomerStatementReportItem>[] =
    [
        createReportSummaryColumn<CustomerStatementReportItem>({
        ...
        createReportTextColumn<CustomerStatementReportItem>({
        ...
        createReportStatusBadgeColumn<CustomerStatementReportItem>({
        ...
        },
        {
            ...
            cell: ({ row }) => formatCurrency(row.original.running_balance),
        },
    ];
