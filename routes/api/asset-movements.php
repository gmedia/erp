...
Route::middleware('permission:asset_movement,true')->group(function () {
    ...
    Route::post('asset-movements', [AssetMovementController::class, 'store'])
        ->middleware('permission:asset_movement.create,true');

    Route::put('asset-movements/{asset_movement}', [AssetMovementController::class, 'update'])
        ->middleware('permission:asset_movement.edit,true');

    Route::delete('asset-movements/{asset_movement}', [AssetMovementController::class, 'destroy'])
        ->middleware('permission:asset_movement.delete,true');
