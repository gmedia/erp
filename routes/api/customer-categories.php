...
Route::middleware('permission:customer_category,true')->group(function () {
    ...
    Route::post('customer-categories', [CustomerCategoryController::class, 'store'])
        ->middleware('permission:customer_category.create,true');

    Route::put('customer-categories/{customer_category}', [CustomerCategoryController::class, 'update'])
        ->middleware('permission:customer_category.edit,true');

    Route::delete('customer-categories/{customer_category}', [CustomerCategoryController::class, 'destroy'])
        ->middleware('permission:customer_category.delete,true');
