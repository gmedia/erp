...
Route::middleware('permission:coa_version,true')->group(function () {
    ...
    Route::post('coa-versions', [CoaVersionController::class, 'store'])
        ->middleware('permission:coa_version.create,true');

    Route::put('coa-versions/{coa_version}', [CoaVersionController::class, 'update'])
        ->middleware('permission:coa_version.edit,true');

    Route::delete('coa-versions/{coa_version}', [CoaVersionController::class, 'destroy'])
        ->middleware('permission:coa_version.delete,true');
