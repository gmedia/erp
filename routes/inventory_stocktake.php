...
Route::middleware(['auth', 'verified'])->prefix('api')->group(function () {
    Route::middleware('permission:inventory_stocktake,true')->group(function () {
        ...
        Route::get('inventory-stocktakes/{inventoryStocktake}', [InventoryStocktakeController::class, 'show']);
        ...
        Route::put('inventory-stocktakes/{inventoryStocktake}', [InventoryStocktakeController::class, 'update'])->middleware('permission:inventory_stocktake.edit,true');
        Route::delete('inventory-stocktakes/{inventoryStocktake}', [InventoryStocktakeController::class, 'destroy'])->middleware('permission:inventory_stocktake.delete,true');
        ...
        Route::post('inventory-stocktakes/{inventoryStocktake}/items', [InventoryStocktakeItemController::class, 'syncItems'])->middleware('permission:inventory_stocktake.edit,true');
    });
});
