...
chmod -R ugo+rw "vendor/pestphp/pest/.temp"
chown -R 1337:1000 "vendor/pestphp/pest/.temp"

mkdir -p "vendor/pestphp/pest-plugin-mutate/.temp"
chmod -R ugo+rw "vendor/pestphp/pest-plugin-mutate/.temp"
chown -R 1337:1000 "vendor/pestphp/pest-plugin-mutate/.temp"
